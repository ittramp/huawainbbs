    ...
    <div class="wrapper">
        ...
        <div class="article-info fn-flex">
            ...
            <a rel="author" href="${servePath}/member/${article.articleAuthorName}">
                ...
                <div class="avatar-mid tooltipped tooltipped-se" aria-label="${article.articleAuthorName}"
            ...
            <div class="fn-flex-1 fn-ellipsis">
                <#if article.articleAnonymous == 0>
                <a rel="author" href="${servePath}/member/${article.articleAuthorName}" class="ft-gray"></#if><strong
                            class="ft-gray">${article.articleAuthorName}</strong><#if article.articleAnonymous == 0>
                </a></#if>
        ...
        <#--贴子类型为3是所谓的'思绪类型'，其它的是普通贴，直接显示内容-->
        ...
        <#--思绪类型的贴子-->
            <div id="thoughtProgress"><span class="bar"></span>
                ...
                <div data-text="" class="content-reset" id="thoughtProgressPreview"></div>
            </div>
                    ...
                    <ul>
                        <li>
                            <div class="fn-flex">
                                ...
                                <a rel="nofollow"
                                   href="${servePath}/member/${article.articleOfferedComment.commentAuthorName}"></#if>
                                ...
                                <div class="fn-flex-1">
                                    <div class="fn-clear comment-info ft-smaller">
                                            <span class="fn-left">
                                                <#if article.articleOfferedComment.commentAnonymous == 0><a
                                                        rel="nofollow"
                                                        href="${servePath}/member/${article.articleOfferedComment.commentAuthorName}"
                                                        class="ft-gray"></#if><span
                                                            class="ft-gray">${article.articleOfferedComment.commentAuthorName}</span><#if article.articleOfferedComment.commentAnonymous == 0></a></#if>
                            ...
                            <li>
                                <div class="fn-flex">
                                    ...
                                    <div class="fn-flex-1">
                                        <div class="fn-clear comment-info ft-smaller">
                                            <span class="fn-left">
                                                <#if comment.commentAnonymous == 0><a rel="nofollow"
                                                                                      href="${servePath}/member/${comment.commentAuthorName}"
                                                                                      class="ft-gray"></#if><span
                                                            class="ft-gray">${comment.commentAuthorName}</span><#if comment.commentAnonymous == 0></a></#if>
    ...
    <#if ADLabel!="">
        <div class="module">
            <div class="module-header">
                <h2>
                    ${sponsorLabel}
                    <a href="https://hacpai.com/article/1460083956075" class="fn-right ft-13 ft-gray"
                       target="_blank">${wantPutOnLabel}</a>
                </h2>
            </div>
...
<#--贴子的头部栏，当贴子滚下去后，在页面最上面显示贴子的title,及相关的操作按钮-->
